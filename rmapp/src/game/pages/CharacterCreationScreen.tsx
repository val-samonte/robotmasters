    ...
    <div className="w-full h-full items-center justify-center p-[1rem]">
      <div className="flex flex-col gap-[0.5rem] h-full">
        ...
        <div className="flex-auto relative overflow-hidden">
          <div className="flex portrait:flex-col absolute inset-0 gap-[0.5rem]">
              ...
              <div className="flex-auto flex flex-col">
                ...
                <Slice9 className="relative flex-auto">
                  <div className="inset-0 absolute flex flex-col overflow-auto custom-scroll">
                    {tab !== 'color' && (
                      <div className="grid grid-cols-2 portrait:grid-cols-1 justify-around">
                    ...
                    {tab === 'color' && (
                      <div className="grid grid-cols-4 portrait:grid-cols-3 justify-around">
                        {paints.map((p) => (
                          <Selectable
                            key={p.id}
                            selected={paint === p.id}
